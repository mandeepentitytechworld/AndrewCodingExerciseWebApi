...
using Andrew.Models;
using Andrew.Services;
using Andrew.Services.Intrefaces;
using Andrew.UnitOfWork;
using AutoMapper;
...
{
    public class ProcessPaymentServiceFake : IProcessPaymentService
    {
        private readonly List<ProcessPaymentViewModel> _processPaymentViewModels;

        public ProcessPaymentServiceFake()
        {
            _processPaymentViewModels = new List<ProcessPaymentViewModel>()
            {
                new ProcessPaymentViewModel() { CartId = 1, UserId= 1,
                    CreditCardNumber = "0000000000000000", CardHolderName="Red", ExpiryDate = "01/22", CVV = "000", Amount = 20 },
                new ProcessPaymentViewModel() {
                    CreditCardNumber = "0000000000000000", CardHolderName="Red", ExpiryDate = "01/22", CVV = "000", Amount = 100 },
                new ProcessPaymentViewModel() {
                    CreditCardNumber = "1111222233334444", CardHolderName="Green", ExpiryDate = "01/23", CVV = "222", Amount = 550 },
            };
        }
        ...
        //public ProcessPaymentServiceFake(EFDBContext context, IMapper mapper)
        //{
